  ...
  return (
    <>
      ...
      <p className="text-center px-3 h5">
        ...
        The responsive interface ensures a seamless experience across both desktop and mobile devices. This combination of search functionality 
        and bookshelf management makes Booksearch an invaluable tool for book enthusiasts.
        </p>
